                ...
                <div className="row">
                    <div className="col-12">
                        <div className="mb-3">
                            ...
                            <input type="text" className="form-control" disabled={isViewModal} value={userObj.name} name='name' onChange={handleFormChange} placeholder="Enter Name" />
                    ...
                    <div classNameName="col-12">
                        <div className="mb-3">
                            ...
                            <input type="number" className="form-control" disabled={isViewModal} value={userObj.age} name='age' onChange={handleFormChange} placeholder="Enter Age" />
                    ...
                    <div classNameName="col-12">
                        <div className="mb-3">
                            ...
                            <input type="text" className="form-control" disabled={isViewModal} value={userObj.location} name='location' onChange={handleFormChange} placeholder="Enter Location" />
